# Node-Express-ElasticSearch Project   ![Version][version-image]
...
```bash
$ git clone https://github.com/arjunkhetia/Node.Js-Express-ElasticSearch-Project.git
```
...
The official low-level Elasticsearch client for Node.js.
...
![Monitoring Page](https://github.com/arjunkhetia/Node.Js-Express-ElasticSearch-Project/blob/master/public/status-monitor.png "Monitoring Page")
